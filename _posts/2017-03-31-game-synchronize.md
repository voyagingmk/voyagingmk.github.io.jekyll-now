...
所以正确的做法是，如果出现收包延迟，只能以一个稍快的时钟频率去播放战斗，不然客户端会表现的“很卡”，玩家就会不爽。当然这个做法这是有代价的，因为玩家当前帧已经滞后了很多，这时候**玩家被禁止操作**，因为玩家都还没到达最新战斗时刻，他还在“过去”，他还处在回放状态，肯定是不能移动或者施法的。所有操作只能被reject忽略掉，直到跟上同步网络。所以玩王者荣耀会见到有时候，明明别人都很正常，自己却动不了的情况。
