...
按照:https://jekyllrb.com/docs/windows/#installation，安装ruby、gem、jekyll。

其中，可能会遇到https的问题，要根据https://gist.github.com/fnichol/867550处理。简单来说下载http://curl.haxx.se/ca/cacert.pem到本机，并添加一个环境变量指向cacert.pem。
