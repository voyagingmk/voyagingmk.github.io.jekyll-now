...
可以看到，四元数的乘积依然还是一个四元数。如果我们把虚数i、j、k替换成有序对：
...
\\[ \\mathbf a = x\_\{a\}i + y\_\{a\}j + z\_\{a\}k\\]
\\[ \\mathbf b = x\_\{b\}i + y\_\{b\}j + z\_\{b\}k\\]
\\[ \\mathbf a\\cdot \\mathbf b = x\_\{a\}x\_\{b\}i\^\{2\}+y\_\{a\}y\_\{b\}j\^\{2\}+z\_\{a\}z\_\{b\}k\^\{2\} \\]
\\[ \\mathbf a\\times \\mathbf b = (y\_\{a\}z\_\{b\}-y\_\{b\}z\_\{a\})i + (z\_\{a\}x\_\{b\} - z\_\{b\}x\_\{a\})j + (x\_\{a\}y\_\{b\} - x\_\{b\}y\_\{a\})k  \\]
