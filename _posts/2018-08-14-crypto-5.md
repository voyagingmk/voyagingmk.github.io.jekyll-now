...
- a=0x0f时，sbox[0x0f]，就是找sbox数组的第0x0f=15个元素，即图中的第一行的最后一个元素76，坐标(0，f）
- a=0x53时，sbox[0x53]，找第0x53个元素，纵坐标0x53/16 = 5，横坐标0x53%16 = 3，第5行第3个元素ed，坐标（5，3）

从中可见，a的低4bits代表横坐标（第几列），高4bits代表纵坐标（第几行）。
